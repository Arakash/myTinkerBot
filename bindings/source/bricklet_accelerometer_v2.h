 ...
 * the data in g/10000 (same unit that is returned by {@link accelerometer_v2_get_acceleration}):
 * 
 ...
 * \ingroup BrickletAccelerometerV2
 *
 * The period in ms is the period with which the {@link ACCELEROMETER_V2_CALLBACK_ACCELERATION}
