...
static void remote_switch_v2_callback_wrapper_switching_done(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + REMOTE_SWITCH_V2_CALLBACK_SWITCHING_DONE];
	(void)packet;
...
static void remote_switch_v2_callback_wrapper_remote_status_a(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + REMOTE_SWITCH_V2_CALLBACK_REMOTE_STATUS_A];
	RemoteStatusA_Callback *callback = (RemoteStatusA_Callback *)packet;
...
static void remote_switch_v2_callback_wrapper_remote_status_b(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + REMOTE_SWITCH_V2_CALLBACK_REMOTE_STATUS_B];
	RemoteStatusB_Callback *callback = (RemoteStatusB_Callback *)packet;
...
static void remote_switch_v2_callback_wrapper_remote_status_c(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + REMOTE_SWITCH_V2_CALLBACK_REMOTE_STATUS_C];
	RemoteStatusC_Callback *callback = (RemoteStatusC_Callback *)packet;
...
void remote_switch_v2_create(RemoteSwitchV2 *remote_switch_v2, const char *uid, IPConnection *ipcon) {
	...
	device_create(remote_switch_v2, uid, ipcon->p, 2, 0, 0);
