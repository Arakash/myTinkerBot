...
static void current25_callback_wrapper_current(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + CURRENT25_CALLBACK_CURRENT];
...
static void current25_callback_wrapper_analog_value(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + CURRENT25_CALLBACK_ANALOG_VALUE];
...
static void current25_callback_wrapper_current_reached(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + CURRENT25_CALLBACK_CURRENT_REACHED];
...
static void current25_callback_wrapper_analog_value_reached(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + CURRENT25_CALLBACK_ANALOG_VALUE_REACHED];
...
static void current25_callback_wrapper_over_current(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + CURRENT25_CALLBACK_OVER_CURRENT];
	(void)packet;
