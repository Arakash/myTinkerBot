...
static void thermocouple_callback_wrapper_temperature(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + THERMOCOUPLE_CALLBACK_TEMPERATURE];
...
static void thermocouple_callback_wrapper_temperature_reached(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + THERMOCOUPLE_CALLBACK_TEMPERATURE_REACHED];
...
static void thermocouple_callback_wrapper_error_state(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + THERMOCOUPLE_CALLBACK_ERROR_STATE];
	bool unpacked_over_under;
	bool unpacked_open_circuit;
	ErrorState_Callback *callback = (ErrorState_Callback *)packet;
