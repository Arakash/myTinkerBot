 ...
 * \ingroup BrickletBarometerV2
 *
 * The period in ms is the period with which the {@link BAROMETER_V2_CALLBACK_AIR_PRESSURE} callback is triggered
 ...
 * \ingroup BrickletBarometerV2
 *
 * The period in ms is the period with which the {@link BAROMETER_V2_CALLBACK_ALTITUDE} callback is triggered
 * periodically. A value of 0 turns the callback off.
 * 
 * If the `value has to change`-parameter is set to true, the callback is only
 * triggered after the value has changed. If the value didn't change
 ...
 * \ingroup BrickletBarometerV2
 *
 * The period in ms is the period with which the {@link BAROMETER_V2_CALLBACK_TEMPERATURE} callback is triggered
 * periodically. A value of 0 turns the callback off.
 * 
 * If the `value has to change`-parameter is set to true, the callback is only
 * triggered after the value has changed. If the value didn't change
