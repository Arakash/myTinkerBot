 ...
 * \ingroup BrickletGPSV2
 *
 * Sets the period in ms with which the {@link GPS_V2_CALLBACK_COORDINATES} callback is triggered
 ...
 * \ingroup BrickletGPSV2
 *
 * Sets the period in ms with which the {@link GPS_V2_CALLBACK_STATUS} callback is triggered
 * periodically. A value of 0 turns the callback off.
 * 
 * The {@link GPS_V2_CALLBACK_STATUS} callback is only triggered if the status changed since the
 * last triggering.
 ...
 * \ingroup BrickletGPSV2
 *
 * Sets the period in ms with which the {@link GPS_V2_CALLBACK_ALTITUDE} callback is triggered
 * periodically. A value of 0 turns the callback off.
 * 
 * The {@link GPS_V2_CALLBACK_ALTITUDE} callback is only triggered if the altitude changed since the
 * last triggering.
 ...
 * \ingroup BrickletGPSV2
 *
 * Sets the period in ms with which the {@link GPS_V2_CALLBACK_MOTION} callback is triggered
 * periodically. A value of 0 turns the callback off.
 * 
 * The {@link GPS_V2_CALLBACK_MOTION} callback is only triggered if the motion changed since the
 * last triggering.
 ...
 * \ingroup BrickletGPSV2
 *
 * Sets the period in ms with which the {@link GPS_V2_CALLBACK_DATE_TIME} callback is triggered
 * periodically. A value of 0 turns the callback off.
 * 
 * The {@link GPS_V2_CALLBACK_DATE_TIME} callback is only triggered if the date or time changed
 * since the last triggering.
