 ...
 * {@link silent_stepper_set_minimum_voltage}. The parameter is the current voltage given
 * in mV.
 */
 ...
 * 
 * * Stallguard Threshold Value: Sets the level for stall output (see {@link silent_stepper_get_driver_status}). The value
 ...
 * \ingroup BrickSilentStepper
 *
 * Sets the minimum voltage in mV, below which the {@link SILENT_STEPPER_CALLBACK_UNDER_VOLTAGE} callback
 ...
 * \ingroup BrickSilentStepper
 *
 * Sets the period in ms with which the {@link SILENT_STEPPER_CALLBACK_ALL_DATA} callback is triggered
