...
static void rs232_callback_wrapper_read(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS232_CALLBACK_READ];
	Read_Callback *callback = (Read_Callback *)packet;
...
static void rs232_callback_wrapper_error(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS232_CALLBACK_ERROR];
	Error_Callback *callback = (Error_Callback *)packet;
