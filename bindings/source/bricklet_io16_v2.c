...
static void io16_v2_callback_wrapper_input_value(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + IO16_V2_CALLBACK_INPUT_VALUE];
...
static void io16_v2_callback_wrapper_all_input_value(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + IO16_V2_CALLBACK_ALL_INPUT_VALUE];
	int i;
...
static void io16_v2_callback_wrapper_monoflop_done(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + IO16_V2_CALLBACK_MONOFLOP_DONE];
	bool unpacked_value;
...
void io16_v2_create(IO16V2 *io16_v2, const char *uid, IPConnection *ipcon) {
	...
	device_create(io16_v2, uid, ipcon->p, 2, 0, 0);
