 ...
 * \ingroup BrickletHallEffectV2
 *
 * The period in ms is the period with which the {@link HALL_EFFECT_V2_CALLBACK_MAGNETIC_FLUX_DENSITY} callback is triggered
 ...
 * in us with {@link hall_effect_v2_set_counter_config}.
 * 
 ...
 * \ingroup BrickletHallEffectV2
 *
 * The period in ms is the period with which the {@link HALL_EFFECT_V2_CALLBACK_COUNTER}
