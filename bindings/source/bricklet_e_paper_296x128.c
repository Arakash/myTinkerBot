...
static void e_paper_296x128_callback_wrapper_draw_status(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + E_PAPER_296X128_CALLBACK_DRAW_STATUS];
	DrawStatus_Callback *callback = (DrawStatus_Callback *)packet;
...
void e_paper_296x128_create(EPaper296x128 *e_paper_296x128, const char *uid, IPConnection *ipcon) {
	...
	device_create(e_paper_296x128, uid, ipcon->p, 2, 0, 0);
