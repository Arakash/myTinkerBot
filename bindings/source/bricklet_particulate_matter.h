 ...
 * \ingroup BrickletParticulateMatter
 *
 * The period in ms is the period with which the {@link PARTICULATE_MATTER_CALLBACK_PM_CONCENTRATION}
 ...
 * \ingroup BrickletParticulateMatter
 *
 * The period in ms is the period with which the {@link PARTICULATE_MATTER_CALLBACK_PM_COUNT} callback
