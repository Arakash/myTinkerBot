 ...
 * 
 * The {@link ACCELEROMETER_CALLBACK_ACCELERATION} callback is only triggered if the acceleration has
 ...
 * to use the {@link ACCELEROMETER_CALLBACK_ACCELERATION} callback and set the period with
