...
static void accelerometer_callback_wrapper_acceleration(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + ACCELEROMETER_CALLBACK_ACCELERATION];
...
static void accelerometer_callback_wrapper_acceleration_reached(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + ACCELEROMETER_CALLBACK_ACCELERATION_REACHED];
	AccelerationReached_Callback *callback = (AccelerationReached_Callback *)packet;
