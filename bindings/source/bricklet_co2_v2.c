...
static void co2_v2_callback_wrapper_all_values(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + CO2_V2_CALLBACK_ALL_VALUES];
...
static void co2_v2_callback_wrapper_co2_concentration(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + CO2_V2_CALLBACK_CO2_CONCENTRATION];
...
static void co2_v2_callback_wrapper_temperature(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + CO2_V2_CALLBACK_TEMPERATURE];
...
static void co2_v2_callback_wrapper_humidity(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + CO2_V2_CALLBACK_HUMIDITY];
...
void co2_v2_create(CO2V2 *co2_v2, const char *uid, IPConnection *ipcon) {
	...
	device_create(co2_v2, uid, ipcon->p, 2, 0, 0);
