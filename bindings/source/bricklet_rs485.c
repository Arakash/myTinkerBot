...
static void rs485_callback_wrapper_read_low_level(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_READ_LOW_LEVEL];
	ReadLowLevel_Callback *callback = (ReadLowLevel_Callback *)packet;
...
static void rs485_callback_wrapper_error_count(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_ERROR_COUNT];
	ErrorCount_Callback *callback = (ErrorCount_Callback *)packet;
...
static void rs485_callback_wrapper_modbus_slave_read_coils_request(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_READ_COILS_REQUEST];
	ModbusSlaveReadCoilsRequest_Callback *callback = (ModbusSlaveReadCoilsRequest_Callback *)packet;
...
static void rs485_callback_wrapper_modbus_master_read_coils_response_low_level(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_READ_COILS_RESPONSE_LOW_LEVEL];
	int i;
	bool unpacked_coils_chunk_data[464];
	ModbusMasterReadCoilsResponseLowLevel_Callback *callback = (ModbusMasterReadCoilsResponseLowLevel_Callback *)packet;
...
static void rs485_callback_wrapper_modbus_slave_read_holding_registers_request(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_READ_HOLDING_REGISTERS_REQUEST];
	ModbusSlaveReadHoldingRegistersRequest_Callback *callback = (ModbusSlaveReadHoldingRegistersRequest_Callback *)packet;
...
static void rs485_callback_wrapper_modbus_master_read_holding_registers_response_low_level(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_READ_HOLDING_REGISTERS_RESPONSE_LOW_LEVEL];
	int i;
	uint16_t aligned_holding_registers_chunk_data[29];

	ModbusMasterReadHoldingRegistersResponseLowLevel_Callback *callback = (ModbusMasterReadHoldingRegistersResponseLowLevel_Callback *)packet;
...
static void rs485_callback_wrapper_modbus_slave_write_single_coil_request(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_WRITE_SINGLE_COIL_REQUEST];
	bool unpacked_coil_value;
	ModbusSlaveWriteSingleCoilRequest_Callback *callback = (ModbusSlaveWriteSingleCoilRequest_Callback *)packet;
...
static void rs485_callback_wrapper_modbus_master_write_single_coil_response(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_WRITE_SINGLE_COIL_RESPONSE];
	ModbusMasterWriteSingleCoilResponse_Callback *callback = (ModbusMasterWriteSingleCoilResponse_Callback *)packet;
...
static void rs485_callback_wrapper_modbus_slave_write_single_register_request(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_WRITE_SINGLE_REGISTER_REQUEST];
	ModbusSlaveWriteSingleRegisterRequest_Callback *callback = (ModbusSlaveWriteSingleRegisterRequest_Callback *)packet;
...
static void rs485_callback_wrapper_modbus_master_write_single_register_response(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_WRITE_SINGLE_REGISTER_RESPONSE];
	ModbusMasterWriteSingleRegisterResponse_Callback *callback = (ModbusMasterWriteSingleRegisterResponse_Callback *)packet;
...
static void rs485_callback_wrapper_modbus_slave_write_multiple_coils_request_low_level(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_WRITE_MULTIPLE_COILS_REQUEST_LOW_LEVEL];
	int i;
	bool unpacked_coils_chunk_data[440];
	ModbusSlaveWriteMultipleCoilsRequestLowLevel_Callback *callback = (ModbusSlaveWriteMultipleCoilsRequestLowLevel_Callback *)packet;
...
static void rs485_callback_wrapper_modbus_master_write_multiple_coils_response(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_WRITE_MULTIPLE_COILS_RESPONSE];
	ModbusMasterWriteMultipleCoilsResponse_Callback *callback = (ModbusMasterWriteMultipleCoilsResponse_Callback *)packet;
...
static void rs485_callback_wrapper_modbus_slave_write_multiple_registers_request_low_level(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_WRITE_MULTIPLE_REGISTERS_REQUEST_LOW_LEVEL];
	int i;
	uint16_t aligned_registers_chunk_data[27];

	ModbusSlaveWriteMultipleRegistersRequestLowLevel_Callback *callback = (ModbusSlaveWriteMultipleRegistersRequestLowLevel_Callback *)packet;
...
static void rs485_callback_wrapper_modbus_master_write_multiple_registers_response(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_WRITE_MULTIPLE_REGISTERS_RESPONSE];
	ModbusMasterWriteMultipleRegistersResponse_Callback *callback = (ModbusMasterWriteMultipleRegistersResponse_Callback *)packet;
...
static void rs485_callback_wrapper_modbus_slave_read_discrete_inputs_request(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_READ_DISCRETE_INPUTS_REQUEST];
	ModbusSlaveReadDiscreteInputsRequest_Callback *callback = (ModbusSlaveReadDiscreteInputsRequest_Callback *)packet;
...
static void rs485_callback_wrapper_modbus_master_read_discrete_inputs_response_low_level(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_READ_DISCRETE_INPUTS_RESPONSE_LOW_LEVEL];
	int i;
	bool unpacked_discrete_inputs_chunk_data[464];
	ModbusMasterReadDiscreteInputsResponseLowLevel_Callback *callback = (ModbusMasterReadDiscreteInputsResponseLowLevel_Callback *)packet;
...
static void rs485_callback_wrapper_modbus_slave_read_input_registers_request(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_SLAVE_READ_INPUT_REGISTERS_REQUEST];
	ModbusSlaveReadInputRegistersRequest_Callback *callback = (ModbusSlaveReadInputRegistersRequest_Callback *)packet;
...
static void rs485_callback_wrapper_modbus_master_read_input_registers_response_low_level(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + RS485_CALLBACK_MODBUS_MASTER_READ_INPUT_REGISTERS_RESPONSE_LOW_LEVEL];
	int i;
	uint16_t aligned_input_registers_chunk_data[29];

	ModbusMasterReadInputRegistersResponseLowLevel_Callback *callback = (ModbusMasterReadInputRegistersResponseLowLevel_Callback *)packet;
...
void rs485_create(RS485 *rs485, const char *uid, IPConnection *ipcon) {
	...
	device_create(rs485, uid, ipcon->p, 2, 0, 0);
