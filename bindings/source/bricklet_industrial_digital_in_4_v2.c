...
static void industrial_digital_in_4_v2_callback_wrapper_value(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + INDUSTRIAL_DIGITAL_IN_4_V2_CALLBACK_VALUE];
	bool unpacked_changed;
	bool unpacked_value;
	Value_Callback *callback = (Value_Callback *)packet;
...
static void industrial_digital_in_4_v2_callback_wrapper_all_value(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + INDUSTRIAL_DIGITAL_IN_4_V2_CALLBACK_ALL_VALUE];
	int i;
	bool unpacked_changed[4];
	bool unpacked_value[4];
	AllValue_Callback *callback = (AllValue_Callback *)packet;
...
void industrial_digital_in_4_v2_create(IndustrialDigitalIn4V2 *industrial_digital_in_4_v2, const char *uid, IPConnection *ipcon) {
	...
	device_create(industrial_digital_in_4_v2, uid, ipcon->p, 2, 0, 0);
