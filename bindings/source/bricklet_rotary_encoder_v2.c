...
static void rotary_encoder_v2_callback_wrapper_count(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + ROTARY_ENCODER_V2_CALLBACK_COUNT];
...
static void rotary_encoder_v2_callback_wrapper_pressed(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + ROTARY_ENCODER_V2_CALLBACK_PRESSED];
	(void)packet;
...
static void rotary_encoder_v2_callback_wrapper_released(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + ROTARY_ENCODER_V2_CALLBACK_RELEASED];
	(void)packet;
