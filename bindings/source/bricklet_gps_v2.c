...
static void gps_v2_callback_wrapper_pulse_per_second(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + GPS_V2_CALLBACK_PULSE_PER_SECOND];
	(void)packet;
...
static void gps_v2_callback_wrapper_coordinates(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + GPS_V2_CALLBACK_COORDINATES];
...
static void gps_v2_callback_wrapper_status(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + GPS_V2_CALLBACK_STATUS];
...
static void gps_v2_callback_wrapper_altitude(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + GPS_V2_CALLBACK_ALTITUDE];
...
static void gps_v2_callback_wrapper_motion(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + GPS_V2_CALLBACK_MOTION];
...
static void gps_v2_callback_wrapper_date_time(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + GPS_V2_CALLBACK_DATE_TIME];
