...
static void color_v2_callback_wrapper_color(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + COLOR_V2_CALLBACK_COLOR];
...
static void color_v2_callback_wrapper_illuminance(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + COLOR_V2_CALLBACK_ILLUMINANCE];
...
static void color_v2_callback_wrapper_color_temperature(DevicePrivate *device_p, Packet *packet) {
	...
	void *user_data = device_p->registered_callback_user_data[DEVICE_NUM_FUNCTION_IDS + COLOR_V2_CALLBACK_COLOR_TEMPERATURE];
...
void color_v2_create(ColorV2 *color_v2, const char *uid, IPConnection *ipcon) {
	...
	device_create(color_v2, uid, ipcon->p, 2, 0, 0);
