 ...
 * \ingroup BrickletCompass
 *
 * The period in ms is the period with which the {@link COMPASS_CALLBACK_HEADING} callback is triggered
 ...
 * \ingroup BrickletCompass
 *
 * The period in ms is the period with which the {@link COMPASS_CALLBACK_MAGNETIC_FLUX_DENSITY} callback
